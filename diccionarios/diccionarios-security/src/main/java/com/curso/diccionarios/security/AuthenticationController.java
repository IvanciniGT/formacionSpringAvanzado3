...
public class AuthenticationController {
    ...
    // Se lo pido a spring.
    private final AuthenticationManager authenticationManager; // Spring lo inyecta

    private final JwtUtil jwtUtil; // Spring lo inyecta

    // Nuestra BBDD Extenda de usuario.
    // Se la pido a Spring... Alguién la habrá configurado.
    private final UserDetailsService userDetailsService; // Spring lo inyecta
